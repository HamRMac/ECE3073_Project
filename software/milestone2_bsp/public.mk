...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosII_processor.sopcinfo
...
# setting hal.stderr is UART_JTAG
ELF_PATCH_FLAG  += --stderr_dev UART_JTAG

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is UART_JTAG
ELF_PATCH_FLAG  += --stdin_dev UART_JTAG
...
# setting hal.stdout is UART_JTAG
ELF_PATCH_FLAG  += --stdout_dev UART_JTAG
